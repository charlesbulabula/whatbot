...
export default {
  ...
  pickAisle: 'Okolinga kobanda na rayon nini ?',
  oftenWith: (p) => `💡 Bazwaka mingi elongo na : *${p.product}*`,
  aisleCount: (p) => `biloko ${p.n}`,
  aisleOther: 'Biloko mosusu',
  btnAllAisles: '↩️ Ba rayon nyonso',
