...
export default {
  ...
  pickAisle: 'Par quel rayon voulez-vous commencer ?',
  oftenWith: (p) => `💡 Souvent pris avec : *${p.product}*`,
  aisleCount: (p) => `${p.n} produit${p.n > 1 ? 's' : ''}`,
  aisleOther: 'Autres produits',
  btnAllAisles: '↩️ Tous les rayons',
